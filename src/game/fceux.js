var FCEUX = (() => {
  ...
  return function (FCEUX) {
    ...
    wasmBinaryFile = FCEUX.FCEUXWasmURL;
    ...
    var asmLibraryArg = {
      ...
      C: __emval_as,
      Z: __emval_decref,
      ma: __emval_run_destructors,
      H: _abort,
      ba: _emscripten_asm_const_double,
      g: _emscripten_asm_const_int,
      Aa: _emscripten_get_now,
      T: _emscripten_memcpy_big,
      p: _emscripten_random,
      s: _emscripten_resize_heap,
      Ca: _emscripten_webgl_create_context,
      Da: _emscripten_webgl_init_context_attributes,
      ...
      oa: _glFramebufferTexture2D,
      ta: _glGenBuffers,
      pa: _glGenFramebuffers,
      ra: _glGenTextures,
      J: _glGetIntegerv,
      ...
      va: _glUniform4f,
      ua: _glUniform4fv,
      E: _glUniformMatrix4fv,
      c: _glUseProgram,
      na: _glVertexAttribPointer,
      k: _glViewport,
      N: _setTempRet0,
      O: _strftime_l,
    };
    ...
    var _audioBufferCallback = (Module['_audioBufferCallback'] = function () {
      return (_audioBufferCallback = Module['_audioBufferCallback'] =
    ...
    var ___emscripten_embedded_file_data = (Module[
